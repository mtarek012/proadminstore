...
import 'inbox_card_model.dart';
export 'inbox_card_model.dart';
...
class _InboxCardWidgetState extends State<InboxCardWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InboxCardModel());
