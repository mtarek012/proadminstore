...
import 'sidebar_phone_model.dart';
export 'sidebar_phone_model.dart';

class SidebarPhoneWidget extends StatefulWidget {
  const SidebarPhoneWidget({super.key});

  @override
  State<SidebarPhoneWidget> createState() => _SidebarPhoneWidgetState();
}

class _SidebarPhoneWidgetState extends State<SidebarPhoneWidget>
    with TickerProviderStateMixin {
  late SidebarPhoneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SidebarPhoneModel());
                                              ...
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'smvort4l' /* Review new products in the chi... */,
                                                  ),
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '0s4dc6v9' /* Product number 325250 is out o... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'nb86qy77' /* Please change the shipping com... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
