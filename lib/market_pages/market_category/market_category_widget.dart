...
import 'market_category_model.dart';
export 'market_category_model.dart';

class MarketCategoryWidget extends StatefulWidget {
  const MarketCategoryWidget({super.key});
...
class _MarketCategoryWidgetState extends State<MarketCategoryWidget>
  ...
  late MarketCategoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MarketCategoryModel());
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'sy02mr7e' /* Review new products in the chi... */,
                                                              ),
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                '0h6yhgoc' /* Product number 325250 is out o... */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodyMedium
                                                          ...
                                                          child: Padding(
                                                            ...
                                                            child: Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                '1vtasi21' /* Please change the shipping com... */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodyMedium
