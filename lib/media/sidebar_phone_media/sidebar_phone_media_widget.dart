...
import 'sidebar_phone_media_model.dart';
export 'sidebar_phone_media_model.dart';

class SidebarPhoneMediaWidget extends StatefulWidget {
  const SidebarPhoneMediaWidget({super.key});

  @override
  State<SidebarPhoneMediaWidget> createState() =>
      _SidebarPhoneMediaWidgetState();
}

class _SidebarPhoneMediaWidgetState extends State<SidebarPhoneMediaWidget>
    with TickerProviderStateMixin {
  late SidebarPhoneMediaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SidebarPhoneMediaModel());
                                              ...
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'o3aq4tof' /* Review new products in the chi... */,
                                                  ),
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'zq85w919' /* Product number 325250 is out o... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'qrxskvjj' /* Please change the shipping com... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
