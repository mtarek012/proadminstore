...
import 'sidebar_phone_pages_model.dart';
export 'sidebar_phone_pages_model.dart';

class SidebarPhonePagesWidget extends StatefulWidget {
  const SidebarPhonePagesWidget({super.key});

  @override
  State<SidebarPhonePagesWidget> createState() =>
      _SidebarPhonePagesWidgetState();
}

class _SidebarPhonePagesWidgetState extends State<SidebarPhonePagesWidget>
    with TickerProviderStateMixin {
  late SidebarPhonePagesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SidebarPhonePagesModel());
                                              ...
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'rxf79npj' /* Review new products in the chi... */,
                                                  ),
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'erkuinm6' /* Product number 325250 is out o... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '6k7r2vg1' /* Please change the shipping com... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
