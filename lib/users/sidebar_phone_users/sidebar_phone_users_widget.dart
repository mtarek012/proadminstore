...
import 'sidebar_phone_users_model.dart';
export 'sidebar_phone_users_model.dart';

class SidebarPhoneUsersWidget extends StatefulWidget {
  const SidebarPhoneUsersWidget({super.key});

  @override
  State<SidebarPhoneUsersWidget> createState() =>
      _SidebarPhoneUsersWidgetState();
}

class _SidebarPhoneUsersWidgetState extends State<SidebarPhoneUsersWidget>
    with TickerProviderStateMixin {
  late SidebarPhoneUsersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SidebarPhoneUsersModel());
                                              ...
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '90obw3pp' /* Review new products in the chi... */,
                                                  ),
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'r3dh0ue6' /* Product number 325250 is out o... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'fmnaq6tk' /* Please change the shipping com... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
